        ...
        switch (activeSection) {
            ...
            case 'paybills':
                return (
                    <div>
                        <h2>Pay Bills</h2>
                        <div className='containerPayBills'>
                ...
                return (
                    <div>
                        <div className='card'>
                            ...
                            <div className="announcementInHome">
                                <p>Shiv Jayanti Celebration - Join us for the grand celebration on 19th February! 🎉</p>
                            </div>
                ...
                <div className='sidebarContent'>
                    {sidebarOpen && (
                        <div style={{ marginTop: '3rem' }}>
                            <div
                                className={`sidebarItem ${activeSection === 'home' ? 'active' : ''}`}
                                onClick={() => setActiveSection('home')}
                            >
                                🏠 Home
                            </div>
                            <div
                                className={`sidebarItem ${activeSection === 'hospital' ? 'active' : ''}`}
                                onClick={() => setActiveSection('hospital')}
                            >
                                🏥 Hospital
                            </div>
                            <div
                                className={`sidebarItem ${activeSection === 'dairy' ? 'active' : ''}`}
                                onClick={() => setActiveSection('dairy')}
                            >
                                🥛 Dairy
                            </div>
                            <div
                                className={`sidebarItem ${activeSection === 'board' ? 'active' : ''}`}
                                onClick={() => setActiveSection('board')}
                            >
                                👥 Board Members
                            </div>
                            <div
                                className={`sidebarItem ${activeSection === 'population' ? 'active' : ''}`}
                                onClick={() => setActiveSection('population')}
                            >
                                📊 Village Data
                            </div>
                            <div
                                className={`sidebarItem ${activeSection === 'schemes' ? 'active' : ''}`}
                                onClick={() => setActiveSection('schemes')}
                            >
                                📜 Schemes
                            </div>
                            <div
                                className={`sidebarItem ${activeSection === 'announcements' ? 'active' : ''}`}
                                onClick={() => setActiveSection('announcements')}
                            >
                                📢 Announcements
                            </div>
                            <div
                                className={`sidebarItem ${activeSection === 'certifications' ? 'active' : ''}`}
                                onClick={() => setActiveSection('certifications')}
                            >
                                📑 All Certifications
                            </div>
                            <div
                                className={`sidebarItem ${activeSection === 'paybills' ? 'active' : ''}`}
                                onClick={() => setActiveSection('paybills')}
                            >
                                💳 Pay Bills
                            </div>
                        </div>
